              ...
              return (
                ...
                >
                  <div className="flex items-center justify-end">
                    <Icon name="arrow_outward" size={18} className="text-white/30 transition-all group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-gradient" />
                  </div>
                  <Icon name={iconName} size={36} className="mt-8 text-gradient" />
